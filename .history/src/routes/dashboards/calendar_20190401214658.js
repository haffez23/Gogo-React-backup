...
class DefaultDashboard extends Component {
  ...
  componentWillMount() {
    ...
    this.setState({
      selectedDevice: this.props.match.params.p,
    });
  ...
  dataListRender() {
    ...
    .then(res => {
      ...
      this.setState({
        numberOfMessage : events1.length,
      });
      console.log("EVENTS1!"+this.state.numberOfMessage)
      return events1
      ...
      this.setState({
        events: data,
        numberOfMessage: length,
        isLoading:true
      });
      console.log("Length2"+length)
      console.log("Length state"+this.state.numberOfMessage)
            ...
            <Card>
              ...
              <CardBody className="d-flex justify-content-between align-items-center">
                <CardTitle className="mb-0">
                  ...
                  {this.state.isLoading?console.log("LEMGTH IF"+0):console.log("LEMGTH ELSE"+this.state.numberOfMessage)}
                  {}
                </CardTitle>
