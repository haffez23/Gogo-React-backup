...
const apiUrl ="http://127.0.0.1:8080/api/devices"
                          ...
                          <CardBody>
                            <Row>
                              ...
                              <Colxx xxs="10" className="mb-3">
                                <CardSubtitle>haffez</CardSubtitle>
                  ...
                  return (
                    <Colxx xxs="12" key={device.id} className="mb-3">
                      ...
                      >
                        <Card
                          onClick={event =>
                            this.handleCheckChange(event, device.id)
                          }
                        ...
                        >
                          <div className="pl-2 d-flex flex-grow-1 min-width-zero">
                            <div className="card-body align-self-center d-flex flex-column flex-lg-row justify-content-between min-width-zero align-items-lg-center">
                              ...
                              <p className="mb-1 text-muted text-small w-150 w-sm-100">
                               category
                              </p>
