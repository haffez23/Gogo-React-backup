...
class FormsUi extends Component {
  ...
  dataListRender() {
    ...
    .then(res => {
      ...
      this.setState({
        items: data.find((e)=>e._id=this.props.match.params.id),
        isLoading:true
      });
  ...
  updateMessageItem(){
    axios.put("localhost:8080/api/messages/"+this.props.match.params.id,{
            ...
            <Card>
              <CardBody>
                ...
                <div className="mb-5">
                  ...
                  <Input 
                        defaultValue= {this.state.items.content}
                         onChange={event => {
                ...
                <Row className="mb-5">
                  <Colxx xxs="6">
                    <DatePicker
                      ...
                      dateFormat="LLL"
                      timeCaption="Time"
                      value={this.state.items.displayAt}
                  ...
                  <Colxx xxs="6">
                    <DatePicker
                      ...
                      dateFormat="LLL"
                      timeCaption="Time"
                      value={this.state.items.hiddenAt}
