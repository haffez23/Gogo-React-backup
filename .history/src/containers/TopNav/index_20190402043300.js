  ...
  render() {
    ...
    return (
      <nav className="navbar fixed-top">
        ...
        <h1 color="secondary">SmartInterphone </h1>

                                        <span className="logo-mobile d-block d-xs-none" />
        </a>

        <div className="ml-auto">
          <div className="header-icons d-inline-block align-middle"> <div className="position-relative d-none d-sm-inline-block">
            ...
            <UncontrolledDropdown className="dropdown-menu-right">
              <DropdownToggle className="p-0" color="empty">
                ...
                <span>
                  ...
                  <i className="simple-icon-user align-middle" />
