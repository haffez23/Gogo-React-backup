          ...
          <div className="scroll">
            ...
            >
              <Nav vertical className="list-unstyled">
                ...
                <NavItem>
                  <NavLink to="/app/layouts/user-list">
                ...
                <NavItem>
                  <NavLink to="/app/layouts/data-list">
                    <i className="iconsmind-Mail-3" />{" "}
                    <IntlMessages id="Device" />
                  </NavLink>
                </NavItem>

                <NavItem>
                  <NavLink to="/app/layouts/message-list">
                    <i className="iconsmind-Mail-Send" />{" "}
